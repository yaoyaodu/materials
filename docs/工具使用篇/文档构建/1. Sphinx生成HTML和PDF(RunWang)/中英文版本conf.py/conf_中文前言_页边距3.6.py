...
\renewcommand{\sphinxmaketitle}{
  ...
  \newpage\newgeometry{left=1.5cm,right=1.5cm,top=2.5cm,bottom=2.5cm}{{\Huge\bfseries\color{blue} 声明}\par \vspace{2ex} 版权所有 © 安徽聆思智能科技有限公司2023。保留一切权利。\par 本文档提供的信息属于安徽聆思智能科技有限公司和/或其关联公司（“聆思科技”）所有，非经聆思科技事先书面许可，任何单位和个人不得以任何方式复制、修改或传播本文档的部分或全部。
\par 本文档内容仅供参考。聆思科技不对本文档所含信息的准确性或完整性作任何明示或暗示的陈述或保证，也不对本文档中存在的任何错误承担责任。\par 聆思科技保留不经通知随时对本文档信息做出修改的权利。聆思科技对本文档享有最终解释权。\par LISTENAI、聆思科技、聆思科技徽标均为安徽聆思智能科技有限公司在中国和其他国家及地区的商标或注册商标。其他所有商标和版权均为其各自所有者的资产。}
  ...
  {\large\bfseries\color{blue} 概述} \par \vspace{2ex} 
  ...
  {\large\bfseries\color{blue} 芯片型号} \par \vspace{2ex} 
  本文档对应的芯片型号为：CSK6002、CSK6012、CSK6011A，后文统一称为CSK6。\par   \vspace{2ex} 
  {\large\bfseries\color{blue} 适用对象} \par \vspace{2ex} 
