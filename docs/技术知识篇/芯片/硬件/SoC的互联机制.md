...
<img src="https://i.loli.net/2021/09/09/YsJozqmE9MWdtXf.png" alt="image-20210909145240643" style="zoom:50%;" />
...
* 点到点方式：用于两个IP核之间的直接连接，两者之间通过握手信号进行通信控制。
* 数据流方式：用于多个IP核之间的数据并发传输。
* 共享总线：用于多个IP核共享一条总线，Wishbone总线支持多主设备的互连，并支持终端用户自定义的仲裁方法。
* 交叉开关：可以同时连接多个主从部件，有利于提高系统的数据吞吐量。
