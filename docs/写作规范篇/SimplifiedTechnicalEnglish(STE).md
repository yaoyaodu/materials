...
- Rule 2.3 When applicable, use an article (the, a, an) or a demonstrative adjective [[u1\]](#_msocom_1) (this, these) before a noun.
...
- Rule 3.3 Use the **past participle** only as an adjective. **过去分词**只用作形容词。
...
- Rule 4.2 Do not omit words or use contractions (（词的）缩约形式) to make your sentences shorter.
...
- Rule 6.1 Give information gradually.
  - Ina descriptive text, give information gradually and make sure that each sentence contains only one topic. If you give too much information too quickly, your text will be difficult to understand and it will be necessary for the reader to read it again.
...
- Rule 8.3 You can use parentheses[[u3\]](#_msocom_3) :
...
- Rule 8.5  **When you put text in parentheses(****圆括号), it counts as one word in that sentence**.

- Rule 8.6  Count each of these as one word:
  - Numbers
  - Units of measurement
  - Abbreviations
  - Alphanumeric identifiers[[u4\]](#_msocom_4) 
  - Quoted text
  - Titles, headings, and placards[[u5\]](#_msocom_5) .

l  Rule 8.7 Hyphenated (带有连字符号的) words count as one word.
...
GR-1 The conjunction连词“that”

GR-2 The preposition “with”

GR-3 How to use pronouns

GR-4 The pronoun代词 “this”
